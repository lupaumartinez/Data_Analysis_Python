...
#import step1_process_raw_data_juli as step1
import step1_process_raw_data_luciana_power as step1
#import step2_fit_antistokes_ratio as step2
import step2_fit_antistokes_ratio_juli as step2
...
#    sigma_abs = 8599 # in nm^2 
    ...
    start_notch = 583 # in nm where notch starts ~525 nm (safe zone)
    end_notch = 606 # in nmwhere notch starts ~540 nm (safe zone)
    start_power = 606 # in nm from here we are going to calculate irradiance
    end_power = 626#660 # in nm from start_power up to this value we calculate irradiance
    start_spr = end_notch # in nm lambda from where to fit lorentz
    max_spr = 630 # wavelength of the spr maximum, initial parameter for the fitting algorithm 
  
    plot_flag = False # if True will save all spectra's plots for each pixel

    # Limites for the antistokes range
    upper_londa = start_notch - 2 #581
    lower_londa = 576# 576# upper_londa - 5 #
...
#    Data analysis for different power
    T_lab_guess = 21# 20#22
    
    control_power = True
    calibration_power_BFP = 2.28, 0.001
    meas_pow_bfp = 0#
...
#### Aca para analizar solo 1 carpeta
   ...
   # NP_folder = '20220524-173839_Luminescence_10x1_3.0umx3.0um'
    ...
    NP_folder = '20220715-174344_Luminescence_Load_grid_in_best_center_size_13'
