...
def bose(energy, Temp):
   ...
   # El = round(lambda_to_energy(592),4)
    El = 2.0943 # excitation wavelength in eV 592
    #El = 2.3305 # excitation wavelength in eV 532
...
def quotient_with_slope(energy, Tzero, slope, Irrad_n, Irrad_m):
    ...
    k = 0.000086173 # Boltzmann's constant in eV/K
   # El = 2.3305 # excitation wavelength in eV 532 nm
    El = 2.0943 # excitation wavelength in eV 592
