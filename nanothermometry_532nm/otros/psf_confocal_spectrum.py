...
def fit_gaussian(gaussian, x, y, rango):
    ...
    bounds = ([0, -rango/2, 200, 0], [1, rango/2, 400, 1])
...
if __name__ == '__main__':
    ...
    starts_anti = 515
    starts_notch = 583 - 2#522-2
    ends_notch = 606#543
    ends_power = 660#560
    plot_range = 'stokes' #'stokes', anti-stokes', 'laser', 'all'
    
    plot_psf = []  #['001'] #te muestra el ajuste para esa NP, para cada bin de wavelength
