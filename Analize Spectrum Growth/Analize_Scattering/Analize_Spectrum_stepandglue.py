...
# 'cyclic', 'greyclip', 'grey' # Solo son estos
    ...
    def get_peak_local_maximum_position(self):
        ...
        if len(values_index_NP) > len(self.index_max):
            ...
            center_NP_list = sorted(center_NP_list, reverse=True)
...
if __name__ == '__main__':
    ...
    # base_folder = '/media/luciana/F650A60950A5D0A3/Ubuntu_archivos/Printing/Luciana Martinez/'
    base_folder = 'C:/Users/lupau/OneDrive/Documentos'
    
   # base_folder = 'C:/Ubuntu_archivos/Printing'
    base_folder = os.path.join(base_folder, 'Luciana Martinez/Programa_Python/Analize Spectrum Growth/Analize_Scattering/')
    file = os.path.join(base_folder, 'Resumen_lamparaIR_new', 'lamparaIR_grade_2.txt')
